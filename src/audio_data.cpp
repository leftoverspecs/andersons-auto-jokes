      ...
      drop_chunk(snd_drop, sizeof(snd_drop))
{
    ...
    snd_laugh.emplace_back(snd_mumble_child1, sizeof(snd_mumble_child1));
    snd_laugh.emplace_back(snd_mumble_female1, sizeof(snd_mumble_female1));
    snd_laugh.emplace_back(snd_mumble_female2, sizeof(snd_mumble_female2));
    snd_laugh.emplace_back(snd_mumble_male1, sizeof(snd_mumble_male1));
    snd_laugh.emplace_back(snd_mumble_male2, sizeof(snd_mumble_male2));
    snd_laugh.emplace_back(snd_mumble_male3, sizeof(snd_mumble_male3));
    snd_laugh.emplace_back(snd_mumble_male4, sizeof(snd_mumble_male4));
    snd_laugh.emplace_back(snd_mumble_male5, sizeof(snd_mumble_male5));
    snd_laugh.emplace_back(snd_steps2, sizeof(snd_steps2));
    snd_laugh.emplace_back(snd_drag, sizeof(snd_drag));
    snd_laugh.emplace_back(snd_drop, sizeof(snd_drop));
